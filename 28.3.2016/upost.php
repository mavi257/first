...
if (isset($_POST['exp'])){
    ...
    $rowsqw = mysqli_query($conqw, "SELECT * FROM post where userid='$userid'");
...
<li class="wp-has-submenu wp-not-current-submenu menu-top menu-icon-post open-if-no-js menu-top-first" id="menu-posts">
	...
	<a href="upost" class="wp-first-item wp-has-submenu wp-has-current-submenu wp-menu-open menu-top menu-top-first menu-icon-dashboard" aria-haspopup="false"><div class="wp-menu-arrow"><div></div></div><div class="wp-menu-image dashicons-before dashicons-admin-post"><br></div><div class="wp-menu-name">Posts</div></a>
	</li>
...
<div id="wpbody-content" aria-label="Main content" tabindex="0">
		...
		<div class="wrap">
          <?php  $sql1356 = "SELECT * FROM post where userid='$userid'  ";
...
if ($result2->num_rows > 0){ ?> 
         <h1>Posts(<?php echo $count789;?>)<a href="createpost" class="page-title-action">Add New</a>
...
<input type="submit" id="delete"  name="bulk_delete_submit" class="button action" value="Apply">&nbsp;
	...
	<thead>
	<tr>
		<td id="cb" class="manage-column column-cb check-column"><label class="screen-reader-text" for="cb-select-all-1">Select All</label><input type="checkbox" name="select_all" id="select_all" value=""/></td><th scope="col" id="title" class="manage-column column-title column-primary sortable desc"><a><span>Title</span></a></th><th scope="col" id="categories" class="manage-column column-categories">Categories</th><th scope="col" id="comments" class="manage-column column-comments num sortable desc"><a href=""><span><span class="vers comment-grey-bubble" title="Comments"><span class="screen-reader-text">Comments</span></span></span></a></th><th scope="col" id="date" class="manage-column column-date sortable asc"><a ><span>published</span></a></th><th scope="col" id="date" class="manage-column column-date sortable asc"><a ><span>updated</span></a></th>	</tr>
    </thead>
...
<div class="row-actions"><span class="edit"><a href="editpost?postid=<?php  echo $row2["postid"];?>" title="Edit this item">Edit</a> | </span><span class="inline hide-if-no-js">| </span><span class="trash"><a class="submitdelete" title="Move this item to the Trash" href="?postid=<?php  echo $row2["postid"];?>">Trash</a> | </span><span class="view"><a href="post?postid=<?php  echo $row2["postid"];?>" rel="permalink">View</a></span></div></td><td class="categories column-categories" data-colname="Categories"><?php echo $category567;?></td>
		...
		<a href="adcom" class="post-com-count post-com-count-approved"><span class="comment-count-approved" aria-hidden="true"><?php echo $count0956;?></span></a>		</div>
                    ...
                    <td class="date column-date" data-colname="Date"><abbr title="<?php echo $row2["created"];?>"><?php echo $row2["created"];?></abbr></td> <td class="date column-date" data-colname="Date"><abbr title="<?php echo $row2["updated"];?>"><?php echo $row2["updated"];?></abbr></td>		</tr>
...
$query78 = "SELECT * FROM post where userid='$userid' ";
...
echo "         <li class='next'><a href='upost?page=".$i."'>".'Older &rarr;'."</a> </li></ul> ";
}
...
echo "     <ul class='pager'>    <li class='previous'><a href='upost?page=".$i2."'>".'&larr; Newer'."</a> </li> ";
...
echo "         <li class='next'><a href='upost?page=".$i1."'>".'Older &rarr;'."</a> </li></ul> ";
