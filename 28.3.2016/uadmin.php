...
<ul id="adminmenu">
	...
	<a href="uadmin" class="wp-first-item wp-has-submenu wp-has-current-submenu wp-menu-open menu-top menu-top-first menu-icon-dashboard" aria-haspopup="false"><div class="wp-menu-arrow"><div></div></div><div class="wp-menu-image dashicons-before dashicons-dashboard"><br></div><div class="wp-menu-name">Dashboard</div></a>
	</li>
...
<div id="wpbody-content" aria-label="Main content" tabindex="0">
        ...
        <?php
$sqlROW = "SELECT * FROM post where userid='$userid'";
...
$sql72 = "SELECT * FROM comment where userid='$userid' ";
...
?>
    ...
    <?php
$sql512 = "SELECT * FROM category where userid='$userid' ";
