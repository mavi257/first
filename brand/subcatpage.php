...
if ($result2->num_rows > 0){?>
     <h3 class="page-header">
                   <a href='index'>Home</a> / <a href=''><?php echo $r56['subcategory']?></a>
                </h3>
...
$query345 = "SELECT * FROM post where subcat_id='$subcat_id'";
...
echo "         <li class='next'><a href='subcatpage?subcat_id=$subcat_id&page=".$i."'>".'Older &rarr;'."</a> </li></ul> ";
}
...
echo "     <ul class='pager'>    <li class='previous'><a href='subcatpage?subcat_id=$subcat_id&page=".$i2."'>".'&larr; Newer'."</a> </li> ";
...
echo "         <li class='next'><a href='subcatpage?subcat_id=$subcat_id&page=".$i1."'>".'Older &rarr;'."</a> </li></ul> ";
