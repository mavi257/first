...
<li class="wp-not-current-submenu menu-top menu-icon-comments" id="menu-comments">
	...
	<a href="admin" class="wp-first-item wp-has-submenu wp-has-current-submenu wp-menu-open menu-top menu-top-first menu-icon-dashboard" aria-haspopup="false"><div class="wp-menu-arrow"><div></div></div><div class="wp-menu-image dashicons-before dashicons-admin-comments"><br></div><div class="wp-menu-name">Comments</div></a>
	</li>
...
$sql1356 = "SELECT * FROM comment  ";
    $result2356 = $conn->query($sql1356);$count789=$result2356->num_rows;
?>
                  Comments<small>(<?php echo $count789;?>)</small>  <button class="btn btn-sm  " >Apply</button>
                </h1>       
 ...
 echo "<table id='export_table' style= ' table-layout: fixed;border-radius:10px;background-color: #ECEFF1; color: #01579B;  width:100%; '><tr height='50px'  ><th style='width:15%;padding-right:40px;'>Author</th><th style='width:30%;padding-right:40px;' >Comment</th><th style='width:30%;padding-right:40px;'>In response to</th><th style='width:15%;padding-right:40px;'  >Date</th></tr>";
 ...
 $postid12=$row2["postid"];
 $sql091 = "SELECT * FROM post where postid=$postid12";
 ...
 $row091 = $result091->fetch_assoc();
         ...
         echo "<tr  height='70px'><td  style='width:15%;padding-right:40px;' >" . $row09["username"]. " </td><td style='width:30%;padding-right:40px;word-wrap:break-word;'  >" .$row2["body"]." </td><td style='width:30%;padding-right:40px;word-wrap:break-word;'  >" .$row091["body"]." </td><td style='width:15%;padding-right:40px;'  >" . $row2["createdat"]. " </td></tr>";
