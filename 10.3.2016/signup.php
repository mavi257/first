...
<div id="wpadminbar" class="ltr">
    ...
    <li id="wp-admin-bar-blog" class="menupop my-sites"><a class="ab-item" aria-haspopup="true" href="index.php">Brand</a>       </li>
                ...
                <li id="wp-admin-bar-my-account" class="menupop with-avatar no-grav"><a  href="login.php" class="btn btn-sm btn-primary" >Have an account? Log&nbsp;in</a>         </li>
 </ul>
