...
<form method="post" enctype="multipart/form-data"  onsubmit="return IsEmpty()" action='upload.php'>
...
" required>
    ...
    <textarea style="height: 320px; margin-top: 15px; width:100%" autocomplete="off" cols="40" name="body" required ></textarea>
...
function IsEmpty() {  
    ...
    if(!document.getElementById('files').value) { 
           alert("file field is a required element for submission"); 
       return false;
    } 
}  
</script> 
