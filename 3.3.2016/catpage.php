...
echo "         <li class='next'><a href='catpage.php?cat_id=$cat_id&page=".$i."'>".'Older &rarr;'."</a> </li></ul> ";
}
...
echo "     <ul class='pager'>    <li class='previous'><a href='catpage.php?cat_id=$cat_id&page=".$i2."'>".'&larr; Newer'."</a> </li> ";
...
echo "         <li class='next'><a href='catpage.php?cat_id=$cat_id&page=".$i1."'>".'Older &rarr;'."</a> </li></ul> ";
